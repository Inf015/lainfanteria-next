...
| T-005 | Carrusel de pilotos en la portada | `Inf015/oliver132123-carrusel-equipo` | PR ABIERTO | 2 | Sin QA: la implementó el PM | No | T-003 (mergeada) | — | r1: no rotaba (`scrollTo` suave no arranca desde un temporizador) y mostraba a todo el equipo. Corregido y observado rotando (`docs/pm/tareas/T-005/validar.md`) |
