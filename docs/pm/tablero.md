...
| T-005 | Carrusel de pilotos en la portada | `Inf015/oliver132123-carrusel-equipo` | PR ABIERTO | 2 | r1 FAIL (6 defectos) → r2: D01–D05 FIXED, D06 abierto | No | T-003 (mergeada) | — | La implementó el PM, sin dev independiente. D06 (testware) se cubre en T-006. Valida Oliver: `docs/pm/tareas/T-005/validar.md` |
| T-006 | Pruebas de navegador con Playwright | `oliver132123/pruebas-navegador` | EN DEV | 1 | — | No | T-005 (apilada sobre su rama) | — | Cierra T-005-D06 y verifica la pausa por puntero y por foco, que el PM no pudo ejercitar. Decisión de Oliver el 2026-09-16 |
